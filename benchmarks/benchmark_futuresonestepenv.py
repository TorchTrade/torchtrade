"""Benchmark script for FuturesOneStepEnv performance optimizations.

This script measures the environment step throughput before and after
the performance optimizations from issue #36.
"""
...
def main():
    print("=" * 70)
    print("FuturesOneStepEnv Performance Benchmark")
    print("=" * 70)
    ...
    _ = benchmark_env_steps(env, n_episodes=10, n_steps_per_episode=20)
