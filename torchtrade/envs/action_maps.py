...
def create_sltp_action_map(
    ...
    Action Space:
        ...
        - Actions 1..N: LONG positions with (stop_loss_pct, take_profit_pct) combinations
        - Actions N+1..M: SHORT positions with (stop_loss_pct, take_profit_pct) combinations
    ...
    Returns:
        ...
        - side is "long", "short", or None for HOLD
        - stop_loss_pct and take_profit_pct are the percentage levels

    Examples:
        >>> # Long-only environment (Alpaca)
